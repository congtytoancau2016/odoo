...
this.showUserInMessage=await this.env.services.user.hasGroup('zalo_connector.group_chat_show_user_in_message')
...
const data=await orm.call(this.env.chatModel,'check_object_reference',['','view_zalo_connector_conversation_chatroom_form'],{context:this.context})
return data[1]}
async getConversationKanbanView(){const{orm}=this.env.services
const data=await orm.call(this.env.chatModel,'check_object_reference',['','view_zalo_connector_conversation_kanban'],{context:this.context})
return data[1]}
async getAiIntefaceView(){const{orm}=this.env.services
const data=await orm.call(this.env.chatModel,'check_object_reference',['','view_zalo_connector_ai_interface_form'],{context:this.context})
return data[1]}
...
if(['apichat.io','chatapi','gupshup'].includes(this.connectorType)){out='acrux_zalo'}
