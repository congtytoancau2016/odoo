...
odoo.define('@zalo_connector/services/chatroomNotification',async function(require){'use strict';let __exports={};const{browser}=require('@web/core/browser/browser')
