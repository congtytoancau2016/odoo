...
const data=await orm.call(this.env.chatModel,'check_object_reference',['_sale','acrux_zalo_sale_order_form_view'],{context:this.context})
return data[1]}}
...
registry.category('views').add('acrux_zalo_sale_order',SaleFormView)
return __exports;});;
